        ...
        <div className="w-full my-5">
          ...
          <div>
            ...
            <p className="font-normal text-base text-opacity-50 text-zinc-950 mb-5">
              The goal of this programme is to provide optimal learning
              opportunities for the purpose of preparing midwives of the highest
              caliber who will function autonomously within the competencies and
              scope of Midwifery practice as defined by the Bangladesh Nursing
          ...
          <div>
            ...
            <p className="font-normal text-base text-opacity-50 text-zinc-950 mb-5">
              ...
              advancement in health sciences. The Diploma in Nursing Science and
              Midwifery curriculum is designed for BNMC recognized institutions
              and incorporate (1) General courses to prepare students to
              understand the world, understand human behaviors and well-behave
              in the society (2) Foundation courses to furnish students with
              essential knowledge relevant to nursing and midwifery and (3)
              Professional courses for nursing and midwifery specific courses.
              The courses are sequenced from year one to year three, from simple
              to complex, with an attempt to increase student’s competencies
              overtime.
            </p>
          </div>
            ...
            <div className="w-full">
              ...
              <div className="font-normal text-base text-opacity-50 text-zinc-950 mb-5">
                <p className="">
                  ...
                  eligible to enter into the diploma in midwifery:
                </p>
                <h3 className="pb-2">
...
export default DiplomaInMidwifery;
