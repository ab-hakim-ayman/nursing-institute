...
const EveningShift = () => {
  return (
    <div
      ...
      className="lg:w-11/12 px-5 lg:px-0 xl:w-9/12 mx-auto grid lg:grid-cols-2 gap-10 items-center my-16 "
    >
      <div className="relative">
        <Image
          ...
          height={1000}
          alt=""
          className="rounded-md transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110  duration-300 cursor-pointer"
        />
      ...
      <div>
        <h2 className="text-primary text-[32px] font-[500]   mb-5">
          Evening shift
        </h2>
        <p>
