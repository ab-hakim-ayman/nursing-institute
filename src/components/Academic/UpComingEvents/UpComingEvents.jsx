...
const UpComingEvents = () => {
  return (
    <div
      id="UpComingEvents"
      className="mt-32 mb-16 lg:w-11/12 px-5 lg:px-0 xl:w-9/12 mx-auto"
    >
      ...
      <div className="border border-[#999] p-8 rounded-lg">
        <div className="grid lg:grid-cols-4 items-center  gap-5  mb-8">
          <div className="flex  md:items-center flex-col md:flex-row  md:gap-10 gap-5 col-span-4 lg:col-span-3  ">
            <div>
              <h2 className="text-[40px] font-[600] text-[#FFBF64]">24</h2>
              <p className="text-[#999] text-[18px]">Jun</p>
            </div>
            <div>
              <h3 className="text-24px font-[600] xl:mb-3 mb-1 ">
                Eid ul - Adha
              </h3>
              <div className="flex items-center flex-wrap gap-5 xl:mb-3 mb-1">
                <div className="flex items-center gap-3 ">
                  <Image
                    ...
                    height={15}
                  />
                  <span className="text-[13px]"> 8:00 - 5:00 PM</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg
        ...
        <div className="grid lg:grid-cols-4 items-center  gap-5  mb-8">
          <div className="flex  md:items-center flex-col md:flex-row  md:gap-10 gap-5 col-span-4 lg:col-span-3  ">
            <div>
              <h2 className="text-[40px] font-[600] text-[#FFBF64]">12</h2>
              <p className="text-[#999] text-[18px]">Jul</p>
            </div>
            <div>
              <h3 className="text-24px font-[600] xl:mb-3 mb-1 ">Ashura</h3>
              <div className="flex items-center flex-wrap gap-5 xl:mb-3 mb-1">
                <div className="flex items-center gap-3 ">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="grid lg:grid-cols-4 items-center  gap-5  mb-8">
          <div className="flex  md:items-center flex-col md:flex-row  md:gap-10 gap-5 col-span-4 lg:col-span-3  ">
            <div>
              <h2 className="text-[40px] font-[600] text-[#FFBF64]">10</h2>
              <p className="text-[#999] text-[18px]">Jul</p>
            </div>
            <div>
              <h3 className="text-24px font-[600] xl:mb-3 mb-1 ">
        ...
        <div className="grid lg:grid-cols-4 items-center  gap-5  mb-8">
          <div className="flex  md:items-center flex-col md:flex-row  md:gap-10 gap-5 col-span-4 lg:col-span-3  ">
            ...
            <div>
              <h3 className="text-24px font-[600] xl:mb-3 mb-1 ">Victory</h3>
              <div className="flex items-center flex-wrap gap-5 xl:mb-3 mb-1">
                <div className="flex items-center gap-3 ">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="flex  items-center justify-center mt-8">
          <button className="border-2 border-[#999] px-4 py-2 rounded text-[#999]">
            View All
          </button>
        </div>
      </div>
